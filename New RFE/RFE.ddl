...
ALTER TABLE F15_A3_RFE_SH ADD CONSTRAINT F15_A3_RFE_SH_F15_A3_RFE_FK FOREIGN KEY ( F15_A3_RFE_rfe_id ) REFERENCES F15_A3_RFE ( rfe_id ) ;

ALTER TABLE F15_A3_RFE_SH ADD CONSTRAINT F15_A3_RFE_SH_F15_A3_RFE_SC_FK FOREIGN KEY ( F15_A3_RFE_SC_status_code ) REFERENCES F15_A3_RFE_SC ( status_code ) ;
